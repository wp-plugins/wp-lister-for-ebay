				...
				<div class="meta-box-sortables ui-sortable">
					...
					<div class="postbox" id="OtherSettingsBox">
						...
						<div class="inside">
							...
							<label for="wpl-option-foreign_transactions" class="text_label"><?php echo __('Handle foreign transactions','wplister') ?></label>
							<select id="wpl-option-foreign_transactions" name="wpl_e2e_option_foreign_transactions" title="Create Orders" class=" required-entry select">
							...
							<label for="wpl-option-allow_backorders" class="text_label"><?php echo __('Allow backorders','wplister') ?></label>
							<select id="wpl-option-allow_backorders" name="wpl_e2e_option_allow_backorders" title="Create Orders" class=" required-entry select">
							...
							<p class="desc" style="display: block;">
								<?php echo __('Should WP-Lister mark proucts as out of stock which have backorders enabled?','wplister'); ?><br>
							</p>
