 ...
 * Shopping API to search for product details.<br><br>Searches for Pre-filled Item 
 * Information within one or more characteristic sets.This kind of search is only 
 * applicable in the context of the Sell Your Item usecase. Use the response to 
 * present the seller with a list of products found in acatalog. (For buy-side 
 * searches, use the <a 
