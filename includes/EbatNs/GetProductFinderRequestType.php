 ...
 * Shopping API to search for product details.<br><br>Retrieves data that you use 
 * to construct valid "product finder" queries(queries against multiple attributes) 
 * against catalog products or (in some cases) listed items.The attributes describe 
 * search criteria (e.g., Manufacturer), as appropriate for the category.Use the 
 * results in combination with GetProductFinderXSL to render the Product Finderin a 
