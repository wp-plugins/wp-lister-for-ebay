 ...
 * class="tablenote"><strong>Note:</strong>Beginning with Version 763, the new 
 * Business Policies Management API and related TradingAPI containers/fields become 
 * available for testing in the Sandbox environment. In May2012, Business Policies 
 * becomes fully functional and sellers can apply Business Policies profiles to 
 * live eBay listings.</span> 
 *
