 ...
 * dependencieson ID-based attributes now. Instead, use GetCategoryFeatures for the 
 * newer Custom Item Specifics model, and use FindProducts in eBay's Shopping API 
 * to search for product details.<br><br>Retrieves mappings between categories and 
 * characteristic setsthat are available for an eBay site. 
 *
