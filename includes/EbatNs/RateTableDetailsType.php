 ...
 * listed the item. <span class="tablenote"> <strong>Important:</strong> 
 * International shipping rate tables are not yet available on the eBay websites. 
 * They will be available starting in version 791 of the Trading API (mid-September 
 * 2012). </span>You can find more information about using shipping rate tables in 
 * the Shipping chapter of the Trading API User's Guide. 
 *
